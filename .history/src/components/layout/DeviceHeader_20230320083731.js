    ...
    <header style={styles.header}>
      <menu style={styles.menu}>
        <li
          ...
          className={css.hoverbold}
        >
          Full
        </li>
        <li id="mobile" style={styles.li} className={css.hoverbold}>
          mobile
        </li>
        <li id="tablet" style={styles.li} className={css.hoverbold}>
          tablet
        </li>
        <li id="laptop" style={styles.li} className={css.hoverbold}>
          laptop
        </li>
        <li id="desktop" style={styles.li} className={css.hoverbold}>
          desktop
        </li>
        <li id="tv" style={styles.li} className={css.hoverbold}>
          tv
        </li>
      </menu>
    </header>
