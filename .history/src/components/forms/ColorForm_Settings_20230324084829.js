...
import StyleGridExpander from "./StyleGridExpander";
...
const ColorForm_Settings = (props) => {
  ...
  return (
    <FormWrapper key="frmColorSet" title={props.title}>
      <StyleGridExpander key="colorGrid" title="Theme Colors">
        {getColorItems()}
      </StyleGridExpander>
      <StyleGridExpander key="variantGrid" title="Calculated Colors">
        {getVariantItems()}
      </StyleGridExpander>
    </FormWrapper>
  );
